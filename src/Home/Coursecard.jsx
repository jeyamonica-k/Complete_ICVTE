...
function Coursecard() {
  return (
    <>
        ...
        shadow-md transition-all duration-500 ease-in-out transform active:scale-105 focus:scale-105 hover:scale-105 focus:shadow-[0px_10px_30px_rgba(0,0,0,0.7)] active:shadow-[0px_10px_30px_rgba(0,0,0,0.7)] hover:shadow-[0px_10px_30px_rgba(0,0,0,0.7)]' >
        ...
        <button className='bg-[#D94426] text-white font-medium border rounded-lg py-2 px-2.5 m-2 cursor-pointer
         active:bg-[#900000] focus:bg-[#900000] hover:bg-[#900000] md:mb-4'>Apply</button>
         </div>
              </>)

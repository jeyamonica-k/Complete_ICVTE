  ...
  return (
      ...
      
   {
    ...
    <img
      src={data.src}
      alt="Example"
      className="w-full h-full object-cover transition duration-300  group-active:blur-[2px] group-active:scale-105 group-hover:blur-[2px] group-hover:scale-105"
    />
  
    {/* Top Red Diagonal Covering Left Top Corner */}
    <div className="absolute top-0 left-0 w-full h-[15%] bg-red-600 transform -skew-y-18 origin-top-left transition-all duration-300 scale-0 group-active:scale-100 group-hover:scale-100"></div>
  
    {/* Bottom Blue Diagonal from Bottom-Left to Top-Right */}
    <div className="absolute bottom-0 left-0 w-full h-1/2 bg-blue-950 transform -skew-y-11 origin-bottom-right transition-all duration-300 scale-0 group-active:scale-100 group-hover:scale-100"></div>
